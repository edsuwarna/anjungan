---
title: Setup Guide
description: Development setup for Anjungan — prerequisites, configuration, and running the stack.
---
...
| `SELF_SERVER_ENABLED` | `false` | Auto-register host server |
| `SELF_SERVER_NAME` | `anjungan-host` | Display name for self-server |
